<?php
	/*
 * Template name: Landing Page Badanie Edu Raport
 */

get_header('badenieedu-raport');
?>
...
p.badanie-pierwsza-edycja, p.badanie-pierwsza-edycja-mobile {
	margin-top: 35px;
	font-size: 16px;
	font-weight: bold;
...
p.badanie-pierwsza-edycja-mobile {
	margin-right: 30px;
