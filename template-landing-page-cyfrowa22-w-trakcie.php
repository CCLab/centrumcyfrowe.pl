...
.registration-buttons .col-sm-6 {
	background-color: #C4D126;
	padding: 40px;
	width: 45%;
}

.registration-buttons .col-sm-6 p br {
	display: none;
}


.registration-buttons .col-sm-6 ul {
	line-height: 1.36;
}

.registration-buttons .col-sm-6 p, .registration-buttons .col-sm-6 p ul {
	font-size: 18px;
}
...
<div class="page-container">
	...
	<div class="registration">
		...
		<div class="row registration-buttons">
			<div class="col-sm-6 green-left">
				<?php the_field('pokoj-1')?>
				<?php 
				$link = get_field('registration-link');
				if( $link ): 
   					 $link_url = $link['url'];
		...
		<?php endif; ?>
			...
			<div class="col-sm-6 green-right">
				<?php the_field('pokoj-2')?>
				<?php 
				$link = get_field('registration-link_2');
				if( $link ): 
   					 $link_url = $link['url'];
    					 $link_title = $link['title'];
    					 $link_target = $link['target'] ? $link['target'] : '_self';
		...
		<div class="networking-opis">
		<?php the_field('networking')?>
			<div class="row registration-buttons">
			  <div class="col-sm-6 green-left yellow-left">
				<?php the_field('fotobudka')?>
				<?php 
				$link = get_field('fotobudka-link');
				if( $link ): 
   					 $link_url = $link['url'];
    					 $link_title = $link['title'];
    					 $link_target = $link['target'] ? $link['target'] : '_self';
		...
		<?php endif; ?>
			...
			<div class="col-sm-6 green-right yellow-right">
				<?php the_field('jamboard')?>
				<?php 
				$link = get_field('jamboard-link');
				if( $link ): 
   					 $link_url = $link['url'];
    					 $link_title = $link['title'];
    					 $link_target = $link['target'] ? $link['target'] : '_self';
		...
		<div class="streaming-opis">
			<?php the_field('streaming-opis')?>
		</div>
		<div class="embed-container">
			<?php the_field('streaming-1-okno')?>
		</div>
		<!-- <div class="streaming-opis">
			<?php the_field('streaming-opis-2')?>
		</div>
		<div class="embed-container">
			<img src="<?php the_field('streaming-2-okno')?>">
		</div> -->
