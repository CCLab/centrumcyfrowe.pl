...
?>
    ...
    <input type="hidden" id="search-for-articles" />
    <main class="czytelnia" id="czytelnia">
        <div class="container">
            ...
            <div class="row filter-box" id="articles-filter-box">
                <div class="col-md-12">
                    ...
                    <ul class="filter-list">
                        ...
                        $categories = get_terms([
                            ...
                            foreach($categories as $category): ?>
                                <li class="bold"><a href="<?php get_permalink() ?>" class="category" data-slug="<?php echo $category->slug; ?>" data-value="<?php echo $category->term_id; ?>"><?php echo $category->name; ?></a></li>
                            <?php endforeach; ?>
                    </ul>
