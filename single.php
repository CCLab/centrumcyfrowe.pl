<?php get_header(); ?>
    ...
    ?>
					<ol class="breadcrumb">
						...
						<li><a href="<?php echo get_permalink(240) . '#' . $current_term->slug ?>"><?php echo $current_term->name; ?></a></li>
				...
				<div class="col-md-4 col-md-offset-2 col-sm-offset-2 col-xs-offset-0 team-member">
					...
					<a href="<?php echo the_permalink($autor->ID) ?>">
                        <div class="team-member-image">
                            <?php if($obrazek = get_field('zdjecie', $autor->ID)){ ?>
                                <img src="<?php echo $obrazek['url'] ?>" alt="<?php echo $autor->post_title . ' - zdjęcie' ?>">
                            <?php } ?>
						</div>
        ...
        ?>
			...
			<div class="row post-info">
				...
				<div class="col-md-4 col-sm-4 col-xs-4 date pull-right">
